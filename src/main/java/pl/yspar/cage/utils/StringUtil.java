...
public class StringUtil {
    ...
    public static List<Location> locationFromString(final List<String> locs) {
        final List<Location> s = new ArrayList<>();
    ...
    public static String replaceItems(String message, final List<ItemStack> items) {
        ...
        for (final ItemStack item : items) {
            if (i == 0) {
                sb.append(item.getAmount()).append(" ").append(item.getType().toString());
            } else {
                sb.append(", ").append(item.getAmount()).append(" ").append(item.getType().toString());
            }
            ++i;
        }
    ...
    public static Map<String, Long> stringToKits(final String string) {
        final Map<String, Long> kits = new HashMap<>();
    ...
    public static String homesToString(final Map<String, Location> homes) {
        ...
        for (final Map.Entry<String, Location> e : homes.entrySet()) {
            if (i == 0) {
                sb.append(e.getKey()).append(":").append(locationLongToString(e.getValue()));
            } else {
                sb.append(";").append(e.getKey()).append(":").append(locationLongToString(e.getValue()));
            }
            ++i;
        }
        return sb.toString();
